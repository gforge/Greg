...
As the variable names often aren't that pretty you can use the `rowname.fn` in order to get the rownames desired. Here's a simple substitution example together with some limits to the digits, and a reference group:
